...
| 列 | 項目名 | 必須 | 説明・制約 |
|----|--------|------|-----------|
| A | 銀行コード | ○ | **4桁の数字**<br/>・全銀協が定めた統一金融機関コード<br/>・例：0001、0005、0009<br/>・必ず4桁で入力（先頭に0がある場合も含む）<br/>・重複登録は不可 |
...
| C | 支店コード | ○ | **3桁の数字**<br/>・各銀行が定めた支店固有のコード<br/>・例：001、123、999<br/>・必ず3桁で入力（先頭に0がある場合も含む）<br/>・同一銀行内での重複登録は不可 |
