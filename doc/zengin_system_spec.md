...
0009,456,1,4567890,ｽｽﾞｷﾊﾅｺ,80000,,
```
...
#### 4.3 出力ファイル仕様
- **ファイル名**: `FB{委託者コード}_{YYMMDD}_{HHMM}.{選択した拡張子}`
- **拡張子選択肢**: 
  - `.dat`（標準的な全銀協フォーマット）
  - `.txt`（テキストファイル形式）
  - `.fb`（FB形式：一部金融機関で使用）
